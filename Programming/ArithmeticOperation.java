...
/*
You are a programmer in a school. The mathematics teacher has asked for your help to teach
basic arithmetic operations to students. Your task is to create a set of functions that will do 
...
Note:
In the sample input, the numbers given to the functions are (20, 5), (4, 5), (20, 4) and (10, 3) respectively.
 The functions correctly return the results of subtraction,multiplication,remainder and find the remainder.
...
public class ArithmeticOperation {
	...
	public static void main(String[] args) {
		...
		int resSub=subtractNumbers(20, 5);
		System.out.println(resSub);
		
		int resMul=multiplyNumbers(4, 5);
		System.out.println(resMul);
		
		double resDiv=divideNumbers(20, 4);
		System.out.printf("%.2f\n",resDiv);

		int resRem=findRemainder(10, 3);	
